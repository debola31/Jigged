...
const menuItems: MenuItem[] = [
  ...
  // checklist + module empty-states; this is the "find it later" home.
  { name: 'Import data', path: '/import', icon: UploadFileIcon },
...
export default function Sidebar({ isMobile, open, onClose, onFeedbackClick }: SidebarProps) {
  ...
  const drawerContent = (
    <>
      ...
      {/* Navigation */}
      <Box component="nav" aria-label="Main navigation" sx={{ flex: 1, pt: 1, pb: 2, px: 1.5 }}>
