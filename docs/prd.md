...
- **Outside (external-vendor) steps — send/receive, not complete.** A step routed to
  ...
  renders as a light-gray highlighted band with a bold "OUTSIDE" flag (the automatic yellow highlighter, low-ink), and
