...
4. Operator opens the step — from their station's job queue, or by scanning the single QR on a job traveler, which opens that part's step list — and taps Mark Complete (part → In Progress)
