...
- **Outside (external-vendor) steps — send/receive, not complete.** A step routed to
  ...
  the **Vendors → Outside work** tab is the shipping lead's worklist. See FR-6a and
