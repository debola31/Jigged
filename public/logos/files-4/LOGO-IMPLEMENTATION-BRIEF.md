...
- Vertical stem: `#4682B4` (Steel Blue)
...
| Steel Blue | `#4682B4` | Logo stem, app UI primary — links, active states, buttons |
| Teal | `#2BBCB3` | Logo hook, secondary accent, success states |
| Dark Indigo | `#1a2744` | Wordmark on light backgrounds |
...
const brandColors = {
  warmAmber: '#D4872A',
  steelBlue: '#4682B4',   // existing — keep as UI primary
  teal: '#2BBCB3',
  darkIndigo: '#1a2744',
  iconBgDark: '#151520',
  iconBgLight: '#F0EDE8',
...
- [ ] Do NOT change: app background colors, sidebar background, login gradient
